 ...
 * @author to
 */
@WebServlet(name = "MovementHistoryServlet", urlPatterns = {"/movement-history"})
public class MovementHistoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Page definition
            request.setAttribute("title", "Historique des mouvements");
            request.setAttribute("contentPage", "./pages/store/movementHistory.jsp");
