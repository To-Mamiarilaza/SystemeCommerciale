 ...
 * @author to
 */
@WebServlet(name = "AcceptOutgoingOrder", urlPatterns = {"/accept-outgoing-order"})
public class AcceptOutgoingOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OutgoingOrderService.acceptOutgoingOrder(idOutgoingOrder);
