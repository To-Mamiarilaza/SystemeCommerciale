...
///Constructors
 ...
 ///Fonctions
    ...
    public void save(PurchaseOrderClient purchaseOrderClient) throws Exception {
        ...
        for(ArticleOrder articleOrder : purchaseOrderClient.getArticleOrder()) {
            ...
            GenericDAO.save(articleOrder, null);
        }
    } 
    ...
    public String getStatusLetter() {
        if(this.getStatus() == 5) {
            ...
            return "En attente demande magasin";
        } else if(this.getStatus() == 15) {
            return "En attente facturation";
